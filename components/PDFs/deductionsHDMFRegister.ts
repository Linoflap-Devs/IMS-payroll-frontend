...
const realData: HDMFRegisterData = {
	"success": true,
	"message": "List of HDMF deduction register for Vessel ID 9 for 6/2024",
	"data": [
		{
			"VesselID": 9,
...
export function generateHDMFRegister(): boolean {
